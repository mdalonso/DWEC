...
let ventana;//Esta variable va a recibir la ventana secundaria
...
function crearVentSec() {
  ...
  if (ventana==undefined || ventana.closed){
    ...
    ventana = open("", "ventana", "height=200,width=200,left=150,top=120");
    //crear una encabezado y un botón en la ventana secundaria
