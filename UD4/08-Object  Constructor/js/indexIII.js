...
if (Object.isSealed(electro)){
    ...
    console.log(electro);
    //La única manera de reutilizar este objeto de forma que podamos
    //modificar su estructura a libertad es crear un nuevo objeto como una copia
    //(Recordamos: el operador spread ... descompone un objeto o un array en sus componente
    //individuales)
    let electroCopia={...electro};
    electroCopia.disponible=true;
    console.log(electroCopia);
