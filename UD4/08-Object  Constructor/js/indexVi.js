...
//Para que la siguiente líneas funcionen hay que comentar la línea 56, ya que ahí se vuelve a definir
// la variable INFORMACIÓN.
//la constante informacion recibe el objeto informacion que está anidado dentro de electro
const {informacion}=electro;
console.log(informacion);

//extraer en una variable el objeto medidas
//Especificándolo de esta forma estamos indicando que medidas está dentro de informacion
