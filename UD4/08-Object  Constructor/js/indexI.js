...
//Añadir un método al prototipo hace que sólo exista una instancia del método en el prototipo de la plantilla y esta será utilizada por todas
//las instancias.
...
function DispElec(nom,precio,color,disco,ram){
    ...
    //Si no lo invocáramos de esta manera, el this asociado a la llamada a Electro sería
    //distinto al this asociado a la llamada a DispElec. Como lo que necesito
    //es que ambas funciones actúen sobre el mismo objeto (el mismo this), necesito
    //llamar a Electro mediante call
